...
void findDivergentPartsPropToExtFreq_3loop_sectorwise(Diagram _diag,
		std::string _path, std::string _cubaPath);
void findDivergentPartsPropToExtFreq_3loop_freqPartwise(Diagram _diag,
		std::string _path, std::string _cubaPath);
void findDivergentPartsPropToExtFreq_3loop_timeOrderingwise(Diagram _diag,
		std::string _path, std::string _cubaPath);
void findDivergentPartsPropToExtFreq_2loop_sectorwise(Diagram _diag,
		std::string _path, std::string _cubaPath);
void findDivergentPartsPropToExtFreq_2loop_freqPartwise(Diagram _diag,
		std::string _path, std::string _cubaPath);
void findDivergentPartsPropToExtFreq_2loop_timeOrderingwise(Diagram _diag,
		std::string _path, std::string _cubaPath);

//===========================================================================
// GPU sectorwise output
void findDivergentPartsPropToExtFreq_2loop_sectorwise_GPU(Diagram _diag,
		std::string _path);
void findDivergentPartsPropToExtFreq_2loop_freqPartwise_GPU(Diagram _diag,
		std::string _path);
void findDivergentPartsPropToExtFreq_2loop_timeOrderingwise_GPU(Diagram _diag,
		std::string _path);
