...
void writeGPUVegas_highestPoleCoef_3loop_partwise(Diagram _diag, std::vector<GiNaC::symbol> _integVars,
		std::vector<GiNaC::ex> _poleCoefs, GiNaC::ex _overallFactor,
		std::string _path, int _k);
void writeGPUVegas_highestPoleCoef_2loop_partwise(Diagram _diag, std::vector<GiNaC::symbol> _integVars,
		std::vector<GiNaC::ex> _poleCoefs, GiNaC::ex _overallFactor,
		std::string _path, int _k);

void writeGPUVegas_eps1_3loop_partwise(Diagram _diag, std::vector<GiNaC::symbol> _integVars,
		std::vector<GiNaC::ex> _poleCoefs, GiNaC::ex _overallFactor,
		std::string _path, int _k);
void writeGPUVegas_eps0_3loop_partwise(Diagram _diag, std::vector<GiNaC::symbol> _integVars,
		std::vector<GiNaC::ex> _poleCoefs, GiNaC::ex _overallFactor,
		std::string _path, int _k);
void writeGPUVegas_eps0_2loop_partwise(Diagram _diag, std::vector<GiNaC::symbol> _integVars,
		std::vector<GiNaC::ex> _poleCoefs, GiNaC::ex _overallFactor,
		std::string _path, int _k);
