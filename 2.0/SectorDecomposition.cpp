...
void findDivergentPartsPropToExtFreq_2loop(Diagram _diag, std::string _path) {
	// Function is void type, very similar to findDivergentPartPropToExtFreq()
	// instead of returning coefficients of poles in a vector of ginac expressions
	// this function writes output file to directory given by _path
	// the output file is in .wls/.cpp format for further use of wolfram mathematica/CUBA
...
void findDivergentPartsPropToExtFreq_2loop_sectorwise(Diagram _diag, std::string _path, std::string _cubaPath) {
	// Function is void type, very similar to findDivergentPartPropToExtFreq()
	// instead of returning coefficients of poles in a vector of ginac expressions
	// this function writes output file to directory given by _path
	// the output file is in .wls/.cpp format for further use of wolfram mathematica/CUBA
	...
	for (int i = 0; i < freqPart.size(); i++) {
		...
		for (int j = 0; j < orderings.size(); j++) {
			...
			for (int k = 0; k < finalInts.size(); k++) {
				...
				integVariables = currentInt.getIntegVars();
				writeCombinedCVegasAndEx_2loop_partwise(diag, integVariables, result,
							finalInts.at(0).getOverallFactor2(), _path, currentPartNum, _cubaPath);
				currentPartNum++;
	...
	writeRunScript_2loop_partwise(_diag, _path, currentPartNum, _cubaPath);

	return;
}

void findDivergentPartsPropToExtFreq_2loop_freqPartwise(Diagram _diag, std::string _path, std::string _cubaPath) {
	// Function is void type, very similar to findDivergentPartPropToExtFreq()
	// instead of returning coefficients of poles in a vector of ginac expressions
	// this function writes output file to directory given by _path
	// the output file is in .wls/.cpp format for further use of wolfram mathematica/CUBA
...
void findDivergentPartsPropToExtFreq_2loop_timeOrderingwise(Diagram _diag, std::string _path, std::string  _cubaPath) {
	// Function is void type, very similar to findDivergentPartPropToExtFreq()
	// instead of returning coefficients of poles in a vector of ginac expressions
	// this function writes output file to directory given by _path
	// the output file is in .wls/.cpp format for further use of wolfram mathematica/CUBA
...
void findDivergentPartsPropToExtFreq_3loop_sectorwise(Diagram _diag, std::string _path, std::string _cubaPath) {
	// Function is void type, very similar to findDivergentPartPropToExtFreq()
	// instead of returning coefficients of poles in a vector of ginac expressions
	// this function writes output file to directory given by _path
	// the output file is in .wls/.cpp format for further use of wolfram mathematica/CUBA
	...
	for (int i = 0; i < freqPart.size(); i++) {
		...
		for (int j = 0; j < orderings.size(); j++) {
			...
			for (int k = 0; k < finalInts.size(); k++) {
				...
				integVariables = currentInt.getIntegVars();
				writeCombinedCVegasAndEx_3loop_partwise(diag, integVariables, result,
							finalInts.at(0).getOverallFactor2(), _path, currentPartNum, _cubaPath);
				currentPartNum++;
	...
	//writeRunScript_3loop_partwise(_diag, _path, currentPartNum, _cubaPath);


	return;
}

void findDivergentPartsPropToExtFreq_3loop_freqPartwise(Diagram _diag, std::string _path, std::string _cubaPath) {
	// Function is void type, very similar to findDivergentPartPropToExtFreq()
	// instead of returning coefficients of poles in a vector of ginac expressions
	// this function writes output file to directory given by _path
	// the output file is in .wls/.cpp format for further use of wolfram mathematica/CUBA
...
void findDivergentPartsPropToExtFreq_3loop_timeOrderingwise(Diagram _diag, std::string _path, std::string _cubaPath) {
	// Function is void type, very similar to findDivergentPartPropToExtFreq()
	// instead of returning coefficients of poles in a vector of ginac expressions
	// this function writes output file to directory given by _path
	// the output file is in .wls/.cpp format for further use of wolfram mathematica/CUBA
...
void findDivergentPartsPropToExtFreq_2loop_sectorwise_GPU(Diagram _diag, std::string _path) {
	// Function is void type, very similar to findDivergentPartPropToExtFreq()
	// instead of returning coefficients of poles in a vector of ginac expressions
	// this function writes output file to directory given by _path
	// the output file is in .wls/.cpp format for further use of wolfram mathematica/CUBA
	...
	for (int i = 0; i < freqPart.size(); i++) {
		...
		for (int j = 0; j < orderings.size(); j++) {
			...
			for (int k = 0; k < finalInts.size(); k++) {
				...
				integVariables = currentInt.getIntegVars();
				writeCombinedGPUVegasAndEx_2loop_partwise(diag, integVariables, result,
						finalInts.at(0).getOverallFactor2(), _path, currentPartNum);
				currentPartNum++;
	...
	writeCompileScript_2loop_partwise_GPU(_diag, _path, currentPartNum);
	writeRunScript_2loop_partwise_GPU(_diag, _path, currentPartNum);

	return;
}

void findDivergentPartsPropToExtFreq_2loop_freqPartwise_GPU(Diagram _diag, std::string _path) {
	// Function is void type, very similar to findDivergentPartPropToExtFreq()
	// instead of returning coefficients of poles in a vector of ginac expressions
	// this function writes output file to directory given by _path
	// the output file is in .wls/.cpp format for further use of wolfram mathematica/CUBA
...
void findDivergentPartsPropToExtFreq_2loop_timeOrderingwise_GPU(Diagram _diag, std::string _path) {
	// Function is void type, very similar to findDivergentPartPropToExtFreq()
	// instead of returning coefficients of poles in a vector of ginac expressions
	// this function writes output file to directory given by _path
	// the output file is in .wls/.cpp format for further use of wolfram mathematica/CUBA
